...
public class AquamiraeDelightClient {
    ...
    public static void registerParticles(RegisterParticleProvidersEvent event) {
        event.register(AquamiraeDelight.SHINE_HEART.get(), ShineParticle::provider);
        event.register(AquamiraeDelight.SHINE_GLINT.get(), SuspendedTownParticle.HappyVillagerProvider::new);
    }
