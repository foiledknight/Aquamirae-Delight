...
public class AQDRecipes extends RecipeProvider {
    ...
    public static void cookingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(AquamiraeDelight.SPINEFISH_ALFREDO.get(), 1, 200, 1.0F).addIngredient(ExistingTag.RAW_FISHES_SPINEFISH).addIngredient(ForgeTags.PASTA).addIngredient(ForgeTags.MILK).addIngredient(AquamiraeDelight.OXYGELIUM_BULB.get()).unlockedByAnyIngredient(new ItemLike[]{AquamiraeItems.SPINEFISH.get(), AquamiraeDelight.SPINEFISH_SLICE.get(), ModItems.RAW_PASTA.get(), Items.MILK_BUCKET, ModItems.MILK_BOTTLE.get(), AquamiraeDelight.OXYGELIUM_BULB.get()}).setRecipeBookTab(CookingPotRecipeBookTab.MEALS).build(consumer, rc("spinefish_alfredo"));

        CookingPotRecipeBuilder.cookingPotRecipe(AquamiraeItems.SEA_STEW.get(), 1, 200, 1.0F).addIngredient(Items.BAKED_POTATO).addIngredient(AquamiraeItems.ESCA.get()).addIngredient(ExistingTag.COOKED_FISHES_SPINEFISH).addIngredient(AquamiraeItems.OXYGELIUM.get()).addIngredient(AquamiraeItems.FIN.get()).addIngredient(Items.PUFFERFISH).unlockedByAnyIngredient(new ItemLike[]{Items.BAKED_POTATO, AquamiraeItems.ESCA.get(), AquamiraeItems.COOKED_SPINEFISH.get(), AquamiraeDelight.COOKED_SPINEFISH_SLICE.get(), AquamiraeItems.OXYGELIUM.get(), AquamiraeItems.FIN.get(), Items.PUFFERFISH}).setRecipeBookTab(CookingPotRecipeBookTab.MEALS).build(consumer, rc("sea_stew"));
    }
    ...
    public void craftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, AquamiraeDelight.ANGLED_KEBAB.get(), 1).requires(ExistingTag.RAW_FISHES_SPINEFISH).requires(AquamiraeDelight.OXYGELIUM_BULB.get()).requires(AquamiraeItems.ANGLERS_FANG.get()).requires(ExistingTag.RAW_FISHES_SPINEFISH).unlockedBy("has_item", InventoryChangeTrigger.TriggerInstance.hasItems(new ItemLike[]{AquamiraeDelight.OXYGELIUM_BULB.get(), AquamiraeItems.ANGLERS_FANG.get(), AquamiraeItems.SPINEFISH.get()})).save(consumer, r("angled_kebab"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AquamiraeDelight.JAR_ITEM.get(), 1).pattern("B B").pattern(" B ").define('B', Items.GLASS_BOTTLE).unlockedBy("has_item", InventoryChangeTrigger.TriggerInstance.hasItems(Items.GLASS_BOTTLE)).save(consumer, r("jar"));
    }
    ...
    public static void smeltingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        foodSmeltingRecipes("golden_puree", ExistingTag.GOLDEN_MOTH_IN_A_JAR, AquamiraeDelight.GOLDEN_PUREE.get(), 0.35F, consumer);
    }
