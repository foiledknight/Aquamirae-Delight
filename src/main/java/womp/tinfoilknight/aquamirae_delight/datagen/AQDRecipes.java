...
public class AQDRecipes extends RecipeProvider {
    ...
    public AQDRecipes(DataGenerator p_125973_) {
        super(p_125973_);
    }
    ...
    private static void fromSlices4(RegistryObject<Block> whole, RegistryObject<Item> slice, Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(whole_item, 1).pattern("SS").pattern("SS").define('S', slice_item).unlockedBy(("has_" + slice_string), InventoryChangeTrigger.TriggerInstance.hasItems(new ItemLike[]{(ItemLike)slice_item})).group("aqd_" + whole_string).save(consumer, r (whole_string + "_from_slices"));
    }
    private static void fromSlices6(RegistryObject<Block> whole, RegistryObject<Item> slice, Consumer<FinishedRecipe> consumer) {
        ...
        ItemLike whole_item = whole.get();
        ItemLike slice_item = slice.get();
        ShapedRecipeBuilder.shaped(whole_item, 1).pattern("SSS").pattern("SSS").define('S', slice_item).unlockedBy(("has_" + slice_string), InventoryChangeTrigger.TriggerInstance.hasItems(new ItemLike[]{(ItemLike)slice_item})).group("aqd_" + whole_string).save(consumer, r (whole_string + "_from_slices"));
    }
